...
Source PNGs are not committed (like external_assets); re-run this if they
change:

    python3 tools/build_menuicons.py [--src ~/Downloads/MenuIcons] [--size 128]
"""
...
def main():
    ...
    ap.add_argument("--src", default=os.path.expanduser("~/Downloads/MenuIcons"))
    ...
    lines = [
        ...
        "-- them to EditableImages. Source PNGs live in ~/Downloads/MenuIcons.",
        "",
        "return {",
        f"\tsize = {args.size},",
        "\tdata = {",
